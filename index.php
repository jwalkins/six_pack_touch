    ...
    <section id="six-pack-timeline" class="visible-lg visible-md">
        <div class="container-fluid">
                ...
                <ul class="timeline">
                    ...
                    <li class="timeline-inverted">
                      <div class="timeline-badge"><p>2018</p></div>
                      <div class="timeline-panel">
                        <div class="timeline-heading">
                          <h4 class="timeline-title">Our best season yet?</h4>
                        </div>
                        <div class="timeline-body">
                          <p>Arguably one of Six Pack's most successful season. 2018 saw <abbr title="Scottish Touch Series">STS</abbr> victories for the Six Pack Roosters at the Edinburgh, Glasgow &amp; Stirling tournaments. This meant the Roosters were crowned Scottish Touch Series Champions for the 2nd season in a row.
                          </p>
                          <br>
                          <p>In the <abbr title="Edinburgh Touch Superleague">ETS</abbr> the women's team were crowned league champions, beating Galaxy Scotland 12-2 in the final and winning all 12 of their league games in the run up to the finals.
                            The men's team were also crowned league champions, beating Galaxy Scotland 6-5 in a tense final.
                          </p>
                          <br>
                          <p>The In2Touch leagues saw Six Pack success with the men's and mixed leagues being won by the Six Pack Storm and Six Pack Sharks respectively.
                          </p>
                          <br>
                          <p>
                            Potentially the biggest result of the season came at the Edinburgh Open, where the Six Pack Roosters saw off competition from some of the UK &amp; Europe's finest touch teams, emerging victorious over a strong BBR team to win in a tense drop-off final and crowned Edinburgh Open Champions 2018.</p>
                        </div>
                      </div>
                    </li>
                </ul>
        ...
        <div class="container text-center">
            ...
            <div class="row">
              ...
              <div class="col-sm-4 col-xs-12 news-item">
                  ...
                  <div class="news-caption">
                      <h4>Stirling STS 2017</h4>
                      <p class="text-muted">Six Pack Roosters Win Stirling STS</p>
                  </div>
              </div>
              ...
              <div class="col-sm-4 col-xs-12 news-item">
                  <a href="#newsModal1" class="news-link" data-toggle="modal">
                      ...
                      <img src="images/news/1.jpg" class="img-responsive" alt="News Item">
                  </a>
                  <div class="news-caption">
                      <h4>Edinburgh STS 2017</h4>
