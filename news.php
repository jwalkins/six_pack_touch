        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a class="page-scroll" title="Find out more about Touch Rugby and Six Pack "href="index.php#about">About</a>
                    </li>
                    <li>
                        <a class="page-scroll" title="Follow us on Instagram" href="index.php#instagram">Instagram</a>
                    </li>
                    <li>
                        <a class="page-scroll" title="Come and join us - find our training and playing areas" href="index.php#find_us">Play Touch</a>
                    </li>
                    <li>
                        <a class="page-scroll" title="Contact Six Pack" href="index.php#contact">Contact</a>
                    </li>
                    <li>
                        <a class="page-scroll visible-lg visible-md" title="Six Pack Timeline" href="index.php#six-pack-timeline">Timeline</a>
                    </li>
                    <li>
                        <a class="page-scroll" title="Our Six Pack committee members" href="index.php#commitee">Committee</a>
                    </li>
                    <li>
